      ...
      <div class="contenido-conocimiento">
        ...
        <div class="desc-conocimiento">
          ...
          <ul>
            ...
            <li>Redes y seguridad de la nube (IAM, reglas de firewall y balanceadores de carga)</li>
            <li>Machine learning e inteligencia artificial de google.</li>
            <li>Control</li>
            <li>VPCs</li>
            <li>Supervision y control de rendimiento  (Cloud monitoring)</li>
          </ul>
        </div>
      </div>
      <hr>
      ...
      <div class="contenido-conocimiento">
        ...
        <div class="desc-conocimiento">
          ...
          <ul>
            ...
            <li>Visualización y edición de archivos</li>
            <li>Permisos y propiedad</li>
            <li>Instalación de paquetes</li>
            <li>Gestión de procesos</li>
            <li>Usuarios y grupos</li>
            <li>Compresión y descompresión</li>
          </ul>
        </div>
      </div>
      <hr>
      ...
      <div class="contenido-conocimiento">
        ...
        <div class="desc-conocimiento">
          ...
          <ul>
            ...
            <li>Copias de seguridad y recuperacion basica</li>
            <li>Optimizacion de consultas y uso de indices</li>
            <li>TRIGGERS</li>
          </ul>
        </div>
      </div>
